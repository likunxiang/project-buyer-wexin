Page({
	...
	onShareAppMessage: function(options) {
		...
		var path = '/pages/pt/group/details?oid=' + self.data.order_info.order_id + "&mch_id=" + mch_id
		return {
	...
	countDownRun: function(limit_time_ms) {
		...
		setInterval(function() {
			var leftTime = (new Date(limit_time_ms[0], limit_time_ms[1] - 1, limit_time_ms[2], limit_time_ms[3],
				limit_time_ms[4], limit_time_ms[5])) - (new Date()); //计算剩余的毫秒数 
