            ...
            getApp().request({
                ...
                success: function(res) {
                    ...
                    if (res.code == 0) {
                        ...
                        // } else {
                        var total_price_1 = 0;
                      if (self.data.type == "GROUP_BUY" || self.data.type == "GROUP_BUY_C") {
                          total_price_1 = parseFloat((res.data.list[0].price - res.data.colonel) > 0 ? (res.data.list[0].price - res.data.colonel) : 0.01) + res.data.express_price;
                        } else {
                          total_price_1 = parseFloat((res.data.list[0].single_price - res.data.colonel) > 0 ? (res.data.list[0].single_price - res.data.colonel) : 0.01) + res.data.express_price;
                        }
