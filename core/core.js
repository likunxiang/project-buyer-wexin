...
if (typeof wx !== "undefined") {
	...
	hj.upFile = function (args) {
		args.header = {
			'mch-id': getApp().core.getStorageSync('_mchInfo').id ,
			'access-token': getApp().core.getStorageSync(getApp().const.ACCESS_TOKEN), 
			'store-id': getApp().envInfo.store_id
		}
